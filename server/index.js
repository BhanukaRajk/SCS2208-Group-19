...
const password = process.env.DB_PASSWORD || "1234567890";
...
const CONNECTION_url =`mongodb+srv://${username}:${password}@cluster0.tfcjplj.mongodb.net/?retryWrites=true&w=majority`;
